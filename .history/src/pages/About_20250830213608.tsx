  ...
  const experience = [
    {
      ...
      duration: "Current",
      description: "Working on various Full Stack Developer projects using modern technologies",
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                A Full Stack  Developer with 1 year of professional experience, dedicated to 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Proficient in modern Full Stack Developer technologies
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Let's collaborate to bring your Full Stack Developer ideas to life with 
